...
P = Patrick Timpone (Host), A = Aajonus
...
P: Here's an email from Robert. He says, I don't agree with Aajonus about the far infrared sauna. Airspace has nothing to do with it. The body is heated from the inside out.
